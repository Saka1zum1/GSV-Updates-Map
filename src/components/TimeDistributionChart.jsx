...
const TimeDistributionChart = ({ data, onClose }) => {
    ...
    return (
        <Draggable handle=".drag-handle">
            <div className="fixed top-1/3 left-1/3 transform -translate-x-1/2 -translate-y-1/2 z-50 w-[calc(100%-2rem)] sm:w-[600px] bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700">
                {/* Header */}
                <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 drag-handle cursor-move">
                    ...
                    {isRangeMenuOpen && (
                        <div className="absolute top-full left-0 mt-1 w-36 bg-white dark:bg-gray-800 rounded-md shadow-lg border border-gray-200 dark:border-gray-700 py-1 z-[70]">
