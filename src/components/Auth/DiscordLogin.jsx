...
const DiscordLogin = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
            <div className="glass-effect rounded-2xl p-8 md:p-12 max-w-md w-full text-center shadow-2xl">
                {/* Title */}
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-8 text-lg">
                    Discover your street view exploration journey this year
                </p>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-6">
                    We only access your Discord ID and username for this session. No data is stored permanently.
                </p>
            </div>
        </div>
    );
